...
def image_lanes(bin_im):                        	#Encuntra el/los carril(es) en una imagen binaria
	...
	for point in points:
		if point-np.mean(lane1) < 25:              #CAMBIE A 50... para no equivocarme y poner un solo carril.. pero ver que paso con eso
			lane1 += [point]
		else:
			lane2 += [point]
...
################
pts1 = np.float32([[110,130],[195,132],[294,240],[15,240]])  #puntos obtenidos apartir de imagen prueba junto con mediciones
